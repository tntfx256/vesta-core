...
describe("Testing Validator.ruleValidator", function () {
    it("required", function () {
        let validValues = ['test', false, {}, []], invalidValues = [null, '', undefined];
    ...
    it("minLength", function () {
        let validValues = ['abcd', 'abcdef'], invalidValues = [null, undefined, '', 'ab'];
    ...
    it("maxLength", function () {
        let validValues = ['', 'ab', 'abcd'], invalidValues = [null, undefined, 'abcdef'];
    ...
    it("min", function () {
        let validValues = [4, 100], invalidValues = [NaN, null, undefined, 3, 0, -1];
    ...
    it("max", function () {
        let validValues = [4, -100, 0], invalidValues = [NaN, null, undefined, 5, 100];
    ...
    it("asset", function () {
        ...
        expect(Validator.ruleValidator.assert(2, (value, field, allValues) => value == allValues['a'], {}, allValues)).toBe(false);
        expect(Validator.ruleValidator.assert(2, (value, field, allValues) => value == allValues['b'], {}, allValues)).toBe(true);
    });
    it("maxSize", function () {
        let validValues = [{ size: 1024 * 1024 }], invalidValues = [null, undefined, { size: 1025 * 1024 }];
    ...
    it("fileType", function () {
        let validValues = [
            { name: 'test.jpg.pdf' },
            { name: 'test.jpg.pdf', type: 'application/pdf' },
            { name: 'test.pdf', type: 'application/octet-stream' }
        ], invalidValues = [null, undefined,
            { name: 'test.pdf', type: 'application/pdf' },
            { name: 'test', type: 'application/octet-stream' },
            { name: 'test.txt' }
        ];
    ...
    it("enum", function () {
        ...
        (function (TestEnum) {
            ...
            TestEnum[TestEnum["Second"] = 2] = "Second";
            TestEnum[TestEnum["Third"] = 3] = "Third";
        })(TestEnum || (TestEnum = {}));
        let invalidValues = [null, undefined, 'test', -3], validValues = [null, undefined, 0, TestEnum.First];
    ...
    it("email", function () {
        let validEmails = ['a@b.co', 'a-b@c-d.co'], invalidEmails = ['ash', 'ab@sdf', 'asd$@tex.com'];
    ...
    it("url", function () {
        let validNumbers = ['http://142.42.1.1', 'http://foo.com/blah_blah'], invalidNumbers = ['http://-a.b.co', 'http://foo.bar?q=Something&foo=bar'];
    ...
    it("number, integer, float", function () {
        let validNumbers = [2, 25, -35, 0, '0', '-33', Infinity, .33], invalidNumbers = [NaN, 'test', '4tr'];
    ...
    it("tel", function () {
        let validNumbers = [9111234567, '+9812345678', '0098 911-123-4567', '0098 (912) 123-4567'], invalidNumbers = [NaN, '98 (912) 123_4567', '1234567'];
    ...
    it("boolean", function () {
        let validValues = [true, false], invalidValues = [NaN, '', 2, null, undefined];
